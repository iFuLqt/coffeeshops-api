...
func (f *facilityRepository) DeleteFacility(ctx context.Context, id int) error {
...
func (f *facilityRepository) UpdateFacility(ctx context.Context, req entity.FacilityEntity, id int) error {
